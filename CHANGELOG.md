# История версий
### v 0.262.2a ```07.10.2021```
* Исправлен ввода начисления в соответствии с запросом - [Issues #46](/../../issues/46).
  Необходимо заново выполнить пункт №4 `Настройка бота Telegram`.
* Добавлена цифровая подпись в приложение.
### v 0.262.0a ```04.10.2021```
* Исправлена ошибка с категориями - [Issues #45](/../../issues/45).
* Добавлен функционал в соответствии с запросом - [Issues #44](/../../issues/44).
* Исправлена ошибка с пустыми категориями - [Issues #43](/../../issues/43).
* Исправлена недочет со средним доходом - [Issues #42](/../../issues/42).
### v 0.260.0a
